  ...
  return (
    <PageShell
      header={
        <PageHeader
          title="History"
          subtitle="Your completed transcripts, audio, and video downloads."
        />
      }
    >
...
//       debug('🔄 Fetching download history...');
...
//         debug('✅ Download history loaded:', data);
...
//         debug('✅ Normalized items:', normalized);
//         setItems(normalized);
//         setConnectionError(null);
//       } else {
...
//                         {item.processing_time && (
//                           <span className="flex items-center gap-1">
//                             ⏱️ {formatProcessing(item.processing_time)}
//                           </span>
//                         )}
//                         {item.language && (
//                           <span className="flex items-center gap-1">
