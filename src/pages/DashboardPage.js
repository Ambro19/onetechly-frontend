...
//   }, [isAuthenticated, navigate, fetchRecentActivity, refreshSubscriptionStatus]);

//   const handleRefresh = async () => {
//     setIsRefreshing(true);
//     try {
//       await Promise.all([fetchRecentActivity(), refreshSubscriptionStatus()]);
//       toast.success('Dashboard refreshed!');
//     } catch (e) {
//       console.error('Error in Dashboard refresh:', e);
//       toast.error('Failed to refresh dashboard');
...
//                   <div>
//                     📄{' '}
//                     <span className={getUsageColor('clean_transcripts')}>
//                       Clean Transcripts: {formatUsage('clean_transcripts')}
//                     </span>
//                   </div>
//                   <div>
//                     🕒{' '}
//                     <span className={getUsageColor('unclean_transcripts')}>
//                       Unclean Transcripts: {formatUsage('unclean_transcripts')}
//                     </span>
//                   </div>
//                   <div>
//                     🎵{' '}
//                     <span className={getUsageColor('audio_downloads')}>
//                       Audio Downloads: {formatUsage('audio_downloads')}
//                     </span>
//                   </div>
//                   <div>
//                     🎬{' '}
//                     <span className={getUsageColor('video_downloads')}>
//                       Video Downloads: {formatUsage('video_downloads')}
//                     </span>
//                   </div>
//                 </div>
//                 {subscriptionStatus?.next_reset && (
...
//                   Start downloading to see your activity here
//                 </div>
//               </div>
//             ) : (
//               <div className="space-y-3">
