...
//         {/* ============ Centered header with official YCD logo (same as Login) ============ */}
//         <div className="flex flex-col items-center text-center mb-6">
//           <span
...
//     <div className="min-h-screen bg-gray-50">
//       <div className="max-w-6xl mx-auto p-6">
//         {/* ===== Brand + Title (matches marketing: OneTechly — YCD) ===== */}
//         <div className="flex flex-col items-center text-center mb-6">
//           <AppBrand
//             size={32}
//             showText
//             label={<span className="whitespace-nowrap"><span className="font-semibold">OneTechly</span> — YCD</span>}
//             title="OneTechly — YCD"
//             logoSrc="/logo_onetechly.png"
//             to="/dashboard"
//           />
...
//         {/* Header */}
//         <div className="flex flex-col items-center text-center mb-6">
//           <span className="inline-flex rounded-full overflow-hidden ring-1 ring-gray-200 shadow-sm bg-white h-14 w-14">
//             <YcdLogo className="block w-[115%] h-[115%] -m-[7%]" />
//           </span>
//           <h1 className="mt-3 text-3xl font-bold text-gray-900">📊 Dashboard</h1>
//           <p className="mt-1 text-sm text-gray-600">
