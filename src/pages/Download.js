// // frontend/src/pages/Download.js — Production-only, cloud-only version
// // - No YCD Desktop Helper integration
// // - Handles subscription limits, next_reset, and normal cloud success
// // - Shows a clear error when YouTube has no captions / blocks our servers
...
//       if (!res.ok) {
//         const raw = data.detail || `${downloadType} download failed`;

//         // normalize the common "no captions / blocked" wording
//         const lowered = String(raw).toLowerCase();
//         const looksLikeNoCaptions =
//           lowered.includes('does not have captions') ||
//           lowered.includes('no captions or youtube blocked our requests') ||
//           lowered.includes('could not retrieve transcript') ||
//           lowered.includes('please try a different video');

//         if (downloadType === 'transcript' && looksLikeNoCaptions) {
//           throw new Error(
//             "This video does not have captions/transcripts available from YouTube's APIs. Please try a different video."
//           );
//         }
